# Отчет о развертывании и тестировании Conntrack (архив)

> Исторический отчёт до релиза v2.2.0. Текущая production-квалификация описана
> в [`STATUS_AND_PLAN.md`](STATUS_AND_PLAN.md).
