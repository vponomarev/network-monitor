# Отчет о тестировании на чистом Debian 12 (архив)

> Результат конкретного тестового запуска. Актуальная матрица qualification
> находится в [`STATUS_AND_PLAN.md`](STATUS_AND_PLAN.md).
