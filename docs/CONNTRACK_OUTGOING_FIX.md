# Исправление проблемы с отслеживанием исходящих подключений (архив)

> Историческое описание исправления. Проверка полного lifecycle теперь
> автоматизирована в [`../tests/conntrack/e2e/README.md`](../tests/conntrack/e2e/README.md).
